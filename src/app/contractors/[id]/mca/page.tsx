...
import { McaIngestForm } from "@/components/McaIngestForm";
import { ENTITY_LABEL } from "@/lib/ui";

export const dynamic = "force-dynamic";

export default async function McaIngestPage({
  params,
}: {
  ...
  return (
    <main className="mx-auto max-w-2xl px-5 py-8 sm:py-10">
      ...
      <p className="mt-3 max-w-prose text-sm text-slate-600">
        Paste the text from this contractor&apos;s{" "}
        <a
        ...
        company or LLP page. The fields are parsed and shown for your
        confirmation before anything is recorded — nothing is stored until you
        attach it.
      </p>

      <div className="mt-6">
        <McaIngestForm contractorId={id} />
      </div>
    </main>
  );
}
